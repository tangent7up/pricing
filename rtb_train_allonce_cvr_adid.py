...
if auto_search_ad:
    adid_to_train = [tup[0] for tup in has_click_dict.iteritems() if tup[1]>20]
...
for adid in adid_to_train:
    ...
    try:
        ...
        pass
    try:
        os.mkdir(path + 'models/ads/'+str(adid))
    except:
        pass
    with open(path + 'models/ads/'+str(adid)+'/model_information','w') as file:
        pickle.dump(model_information,file)
    with open(path + 'models/ads/'+str(adid)+'/columns_information','w') as file:
